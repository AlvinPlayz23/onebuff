...
const backgroundProcesses = new Map<number, any>()
...
export const runTerminalCommandTool: ToolDefinition = {
  ...
  handler: async (params: RunTerminalCommandParams, context: ToolContext): Promise<ToolResult> => {
    try {
...
async function runSyncCommand(
  ...
  try {
    const options: any = { cwd, encoding: 'utf8' }
...
export function getBackgroundProcessStatus(processId: number) {
...
export function killBackgroundProcess(processId: number): boolean {
