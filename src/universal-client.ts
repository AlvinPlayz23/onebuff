...
import { ModelConfig, ChatMessage } from './types.js'
import { OnebuffConfigManager } from './onebuff-config.js'

export class UniversalClient {
  private configManager: OnebuffConfigManager
  ...
  async chat(messages: ChatMessage[], model?: string, options?: { temperature?: number, maxTokens?: number }) {
